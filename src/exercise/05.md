...
In this module we used the state reducer pattern to reduce complexity of state
management within a given component. We also ensured that users can extended
or override the reducer by making it accessible to the users of the component API
and also provide them with a little actionTypes helper object, to ensure no typos
occur in larger projects.
